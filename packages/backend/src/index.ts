...
const dataEnvPathGlobal = resolveBackendDataPath('.env'); // Renamed to avoid conflict if 'dataEnvPath' is used later
...
const startServer = () => {
    ...
    const sessionsPath = resolveBackendDataPath('sessions');
    ...
    server.listen(port, () => {
        ...
        console.log("BACKEND_READY_SIGNAL");
