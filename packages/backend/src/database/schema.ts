...
CREATE TABLE IF NOT EXISTS terminal_themes (
    ...
    selection_inactive_background TEXT,
    scrollbar_slider_background TEXT,
    scrollbar_slider_hover_background TEXT,
    scrollbar_slider_active_background TEXT,
    overview_ruler_border TEXT,
    extended_ansi TEXT,
    black TEXT,
    red TEXT,
    green TEXT,
